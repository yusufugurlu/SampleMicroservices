...
using SampleMicroservices.IdentityServer.Data;
        ...
        public static int Main(string[] args)
        {
            ...
            try
            {
                ...
                using (var scope= host.Services.CreateScope())
                {
                    ...
                    {
                        userManager.CreateAsync(new ApplicationUser() {UserName="test", Email="test@test.com",City="Istanbul" },"Password12*").Wait();
                    }
                }
