...
using SampleMicroservices.Web.Models.Orders;
...
namespace SampleMicroservices.Web.Services
{
    public class OrderService : IOrderService
    {
        ...
        public async Task<OrderCreatedViewModel> CreateOrder(CheckoutInfoInput checkoutInfoInput)
        {
            ...
            {
                var orderItem = new OrderItemCreateInput { ProductId = x.CourseId, Price = x.GetCurrentPrice, PictureUrl = "", ProductName = x.CourceName };
